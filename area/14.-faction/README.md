...
派别是一群在同一名称和旗帜下一起玩《撕裂》的玩家，他们对游戏有着共同的看法。派别由一个领导者和一个可选的联合领导者领导；除了集体犯罪和战争努力（通过[多人运动](OC.md)和[战争](Warfare.md)）之外，他们还允许共享资源（通过[军械库](Armory.md)）。

## 创建帮派
派别是《撕裂》中最受欢迎的活动之一。开始一个新的派别需要花费1000美元\*当前游戏中的派别数量，尽管在[论坛](../12.-lun-tan.md)的派别买卖主题中可以用更少的钱购买一个派别。一个全新的派别将有5,000个敬意，并将设在一个棚子里，提供最多5个成员的空间。这可以在[升级面板](#升级面板)中进一步升级。

一个派别的成功可以通过它目前的尊重总额和它所拥有的升级来衡量。要查看游戏中最好的派别，请到报纸上的[HOF](../13.-ming-ren-tang.md)。

### 当领袖AFK时...
如果一个派别的领导人不活跃超过30天，领导权将自动转移给共同领导人。如果该派别没有共同领袖，它将被转移到过去24小时内在线时间最长的成员。


### 申请过程

- 玩家现在最多可以同时拥有10个派别的**申请**。这意味着他们可以自由地同时申请几个派别，大大提高了他们迅速进入一个派别的机会。这解决了向一个派别申请，等待答复，然后再向另一个派别申请的繁琐过程。

- 派别领导人将不再收到每份申请的新闻或事件垃圾邮件。相反，我们已经实施了一个单独的通知系统，提醒有权限的人注意待定的申请。

- 玩家可以在申请发出后的任何时候编辑他们的申请，或者通过相关的派别资料撤回他们。

- 一旦申请被接受，所有其他相关的申请将被删除。因此，作为一个派别领导人，你看到的所有申请都是来自现在可以加入的玩家。

- 如果一个申请被拒绝，该玩家将不能在7天内再次申请。这些7天的重新申请限制可以由派别通过切换 "允许申请 "关闭和打开来覆盖。

- 如果申请没有被接受或拒绝，72小时后就会过期。

## 帮派战争
这些是各派别为了获得尊重、攀登[名人堂](../13.-ming-ren-tang.md)和得到撕裂社区的认可而使用的功能/玩法。

### 面子
尊重是大多数派别都会为之奋斗和牺牲的东西。它可以用来向撕裂社区展示你的派别有多好，它可以用来作为吹嘘的权利，也可以用来升级派别的特质。获得和失去尊重的方式有很多。
...
- 大多数派别都会进行[有组织犯罪](OC.md)，目的是为了获得尊重，以及在这个过程中获得一些金钱。它们的难度和所需的成员数量各不相同。

- 电视台公司的特别项目 "宣传 "允许员工将工作点数用于为他们所在的派别赢得尊重。派别新闻日志也会有这方面的记录。

#### 失去面子

- 当一个派别被[肮脏炸弹](DirtyBomb.md)击中时，它将失去大量的尊重，并受到其他一些影响。

- 当一个派别的成员被攻击时，该派别将失去攻击者所获得的25%的尊敬。

### 连击

查看有关[链条](Chain.md)的主要文章

锁链是一种战争工具，旨在补充两个派系之间的战争。连续击中你的派别以外的玩家将建立一个 "连锁"，随着连锁的建立，逐渐赢得更多的尊重--偶尔也会达到 "奖励 "击中，获得大量额外的尊重。


- 链条必须通过花费尊重来解锁。一旦一个派别完成了既定长度的连锁，它就可以解锁下一个长度的连锁。这些购买是不可退还的。
...
突袭是一种纯粹的破坏性战争形式，于[19年1月8日](https://www.torn.com/forums.php#/p=threads&t=16076707)发布。任何派别都可以开始对另一派别进行无限期的突袭，在此期间，只能从对手那里获取尊重，而不是赢得尊重。

在突袭期间，任何一方的攻击都会造成100%的尊重损失（相比之下，普通攻击造成的损失为25%）。

你从对方派别获得的尊重将被添加到你派别的突袭分数中。
...
一个派别每次只能与一个派别开始突击行动。如果你的派别参与了一次突袭，在当前的突袭停止之前，它将不能开始另一次突袭。然而，你的派别可以同时被多个派别突袭。

注意：如果你的派别开始突袭，它将迫使任何当前的链子进入其冷却状态，所以链子应该在你的派别宣布突袭之前完成或开始。

#### 取消突袭

一旦过了24小时，得分最高的派别（获得最多的尊重）就可以选择 "停止 "突袭。

如果满足以下任何条件，失败的派别也可以停止突袭：

- 任何一方在72小时内没有进行攻击

- 胜利方的成员少于10人[1](#cite_1)。

得分最低的派别也可以在任何时候选择投降，然而这只是通知对方派别你希望突击行动结束。他们可以选择接受你的投降并停止，或者无视它并继续。

交易的和平条约将在约定的时间内停止并阻止突袭。

在极少数情况下，一个派别的总尊重可能达到0，在这种情况下，该派别会被[摧毁](#帮派销毁)。

### 帮派销毁

当一个派别的尊重度为零时，他们将被永久地摧毁。派别不会被完全删除，但会进入不可恢复的死亡状态--这意味着派别无法被访问，但其资料--显示其名称、形象和前任领导人--将被永远保留。
...
有组织犯罪小组允许规划有组织犯罪。**有组织犯罪**是由一个**派别**的成员进行的团体活动，目的是为了获得现金和对该派别的尊重，以及为参与的成员获得犯罪经验。

这个面板允许拥有适当权限的人计划和发起有组织犯罪，以及计划离开派别的人取消他们自己的有组织犯罪。


## 升级面板

升级面板是派别管理的核心和关键。它分为两个部分，核心分支和特殊升级分支。
...
为了解锁更多的专业化分支，一个派别必须同时拥有指定数量的升级活动。一旦达到解锁专业分支的要求，它将被永久解锁，即使该派别目前拥有的升级总数低于指定数量。
...
关于派别挑战的更多信息，请查看[派别挑战](Faction_Challenge.md)页面。

## 控制面板

这里是修改派别概况、发送通讯、编辑用户权限和创建肮脏炸弹的地方。

### 给予用户

允许派别领导人、共同领导人或任何被授予 "给钱 "和 "给分 "权限的人在 "给用户 "面板中看到派别所有成员的金钱和积分余额，并给成员金钱或积分。当成员捐赠金钱/积分时，这些余额会增加，如果被给予金钱/积分则会减少。发薪日 "功能不会影响金钱余额。领袖或共同领袖可以将余额调整为任何数值；这只改变会员显示的余额，没有其他影响。会员可以在军械库页面上看到自己的个人余额。
...
**派别[论坛](../12.-lun-tan.md)**：派别论坛是你与你的成员交谈、发布想法、派别服务和报价的地方。它也是发布派别最新信息的主要场所，一个良好的论坛对于派别的成功至关重要。所有的派别成员都可以创建主题并在其中发帖，但只有某些派别的工作人员可以删除不属于他们的主题或制作贴纸。


**派别聊天框**：这是派别成员实时交谈的地方，在连锁经营或寻求派别方面的帮助时很有用。


**通讯**：一些派别工作人员可以发送通讯，通常，这些信件有关于派别的重要信息，通常最好关注这些信息。

### 支付日

允许有送钱权限的成员同时向多个派别成员送钱。

### 申请

在这里，你可以查看、接受或拒绝已申请加入你的派别的用户的申请。从管理标签中撤回申请的用户将显示 "撤回状态"。
...
新成员默认会收到一个 "新兵 "职位，对派别的访问是有限的。72小时后，成员会收到派别的默认职位，领导人和联合领导人可以重新命名。
...
一个派别的领袖，也只有领袖可以选择删除他们的派别。但是，如果该派别有超过100,000人的尊重，则不能这样做。[4](#cite_4)

派别每小时删除一次，只有在这之后，领袖才能够永久地离开派别。

## 历史说明


- [不活跃的派别领袖没有正确晋升](https://www.torn.com/forums.php#/p=threads&t=16114682&to=19599870)--将每天不活跃的派别领袖替换为过去24小时内在线时间最长的联合领袖或成员
